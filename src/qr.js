...
// Import BBQr library functions - using require for browserify compatibility
let BBQrLib;
try {
    // Try dynamic import for ES modules
    if (typeof require !== 'undefined') {
        // We'll load the browser version for browserify
        BBQrLib = window.BBQr || require('bbqr/dist/bbqr.iife.js');
    }
} catch (error) {
    console.warn('BBQr library not loaded in Node.js environment, will be available in browser');
}
